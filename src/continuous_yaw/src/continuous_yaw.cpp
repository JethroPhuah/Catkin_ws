...
int main(int argc, char **argv)
{
    ...
    current_pos_sub = nh.subscribe<gazebo_msgs::ModelStates>
    ...
    local_yaw_pub = nh.advertise<geometry_msgs::Twist>
            (followerNS + "/mavros/setpoint_velocity/cmd_vel_unstamped", 10);

    local_raw_pub = nh.advertise<mavros_msgs::PositionTarget>
            (followerNS + "/mavros/setpoint_raw/local", 10);
