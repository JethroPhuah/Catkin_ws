...
TEST(common, FOLLOW_TARGETS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::FOLLOW_TARGETS packet_in{};
    packet_in.lat = 963497464;
    packet_in.lon = 963497672;
    packet_in.alt = 73.0;

    mavlink::common::msg::FOLLOW_TARGETS packet1{};
    mavlink::common::msg::FOLLOW_TARGETS packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, FOLLOW_TARGETS)
{
    mavlink_message_t msg;
    ...
    mavlink_follow_targets_t packet_c {
    ...
    mavlink_msg_follow_targets_encode(1, 1, &msg, &packet_c);
